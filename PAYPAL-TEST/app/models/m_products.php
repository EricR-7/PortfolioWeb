...
class Products {
    ...
    */
    ...
    /*
    Creatiuon of page elements
    */

    /**
     * Create product table using the database
     * 
     * @access public
    ...
    public function create_product_table($cols = 6, $category = NULL){
        ...
        if(!empty($products)){
            ...
            foreach($products as $product){
                ...
                $data .= '<img src="' . IMAGE_PATH . $product['image'] . '" alt="' . $product['name'] . '" />';
